...
const registerform = () => {
    ...
    const registerFunction = async () => { // function to register new user
        ...
        try {
            const response = await fetch("http://localhost:3000/register", {
              ...
              body: JSON.stringify({ email, password, information, registerationdate }),
            });
    ...
    <div className='registerDiv'> 
        ...
        <input type="text" id='username' placeholder='Username' autoComplete='off' onChange={(e)=>setEmail(e.target.value)}/>
        <br />
